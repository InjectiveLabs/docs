...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=https://github.com/InjectiveLabs/sdk-python/raw/master/examples/chain_client/31_MsgCreateBinaryOptionsLimitOrder.py) -->
<!-- The below code snippet is automatically added from https://github.com/InjectiveLabs/sdk-python/raw/master/examples/chain_client/31_MsgCreateBinaryOptionsLimitOrder.py -->
```py
import asyncio
import uuid
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=https://github.com/InjectiveLabs/sdk-python/raw/master/examples/chain_client/32_MsgCreateBinaryOptionsMarketOrder.py) -->
<!-- The below code snippet is automatically added from https://github.com/InjectiveLabs/sdk-python/raw/master/examples/chain_client/32_MsgCreateBinaryOptionsMarketOrder.py -->
```py
import asyncio
import uuid
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=https://github.com/InjectiveLabs/sdk-python/raw/master/examples/chain_client/33_MsgCancelBinaryOptionsOrder.py) -->
<!-- The below code snippet is automatically added from https://github.com/InjectiveLabs/sdk-python/raw/master/examples/chain_client/33_MsgCancelBinaryOptionsOrder.py -->
```py
import asyncio
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=https://github.com/InjectiveLabs/sdk-python/raw/master/examples/chain_client/34_MsgAdminUpdateBinaryOptionsMarket.py) -->
<!-- The below code snippet is automatically added from https://github.com/InjectiveLabs/sdk-python/raw/master/examples/chain_client/34_MsgAdminUpdateBinaryOptionsMarket.py -->
```py
import asyncio
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=https://github.com/InjectiveLabs/sdk-python/raw/master/examples/chain_client/35_MsgInstantBinaryOptionsMarketLaunch.py) -->
<!-- The below code snippet is automatically added from https://github.com/InjectiveLabs/sdk-python/raw/master/examples/chain_client/35_MsgInstantBinaryOptionsMarketLaunch.py -->
```py
import asyncio
...
<!-- MARKDOWN-AUTO-DOCS:START (CODE:src=https://github.com/InjectiveLabs/sdk-python/raw/master/examples/chain_client/36_MsgRelayProviderPrices.py) -->
<!-- The below code snippet is automatically added from https://github.com/InjectiveLabs/sdk-python/raw/master/examples/chain_client/36_MsgRelayProviderPrices.py -->
```py
import asyncio
