...
``` python
https://github.com/InjectiveLabs/sdk-python/blob/master/examples/chain_client/4_MsgCreateSpotMarketOrder.py
```
...
``` python
https://github.com/InjectiveLabs/sdk-python/blob/master/examples/chain_client/3_MsgCreateSpotLimitOrder.py
```
