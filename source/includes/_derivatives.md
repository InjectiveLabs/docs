...
``` python
https://github.com/InjectiveLabs/sdk-python/blob/master/examples/chain_client/7_MsgCreateDerivativeMarketOrder.py
```
...
``` python
https://github.com/InjectiveLabs/sdk-python/blob/master/examples/chain_client/6_MsgCreateDerivativeLimitOrder.py
```
...
async def main() -> None:
    ...
    gas_price = 500000000
    base_gas = 85000
    gas_limit = base_gas + 25000  # add 25k for gas, fee computation
    gas_fee = '{:.18f}'.format((gas_price * gas_limit) / pow(10, 18)).rstrip('0')
    fee = [composer.Coin(
        amount=gas_price * gas_limit,
        denom=network.fee_denom,
